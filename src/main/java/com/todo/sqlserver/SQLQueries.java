...
public class SQLQueries {
    public static final String FETCH_TODO_FOLDERS = "SELECT [ID],[NAME],[DESCRIPTION],[CREATED_ON],[MODIFIED_ON] FROM TODO_FOLDERS";
    public static final String FETCH_TODO_FOLDER = "SELECT [ID],[NAME],[DESCRIPTION],[CREATED_ON],[MODIFIED_ON] FROM TODO_FOLDERS WHERE ID = ?";
